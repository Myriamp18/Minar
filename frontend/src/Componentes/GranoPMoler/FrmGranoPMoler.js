...
function FrmGranoPMoler() {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://localhost:8081/creategranomoler', { ...values, saldo: nuevoSaldo })
        .then(res => {
            console.log(res);
            navigate('/granomoler');
        })
