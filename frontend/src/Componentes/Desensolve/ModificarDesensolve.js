...
function ModificarDesensolve() {
    ...
    const handleSubmit = (e) => {
      e.preventDefault()
      axios.put(`http://localhost:8081/updatedesensolve/${id}`, values)
  ...
  useEffect(() => {
    axios.get(`http://localhost:8081/getrecorddesensolve/${id}`)
        .then((res) => {
...
export default ModificarDesensolve
