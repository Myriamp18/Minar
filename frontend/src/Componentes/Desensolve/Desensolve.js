...
function Desensolve() {
    ...
    useEffect(() => {
      fetch('http://localhost:8081/desensolve')
        .then(res => res.json())
    ...
    const handleDelete = (id) => {
      axios.delete(`http://localhost:8081/deletedesensolve/${id}`)
        .then(res => {
...
<>
   ...
   <h1>Desensolve 4.00-4.04:</h1>

   <div className="text-center">
     <Link to="/createdesensolve" className="btn btn-danger btn-lg font-weight-bold   text-lg" >
                 ...
                 <tr key={i}>
                   ...
                   <td>
                     <div style={{ display: 'flex', alignItems: 'center' }}>
                       <Link to={`/updatedesensolve/${d.id}`} className='btn btn-warning'>
