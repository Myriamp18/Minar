...
function MofificarHJigs() {
    ...
    const [values, setValues] = useState({
      ...
      const handleSubmit = (e) => {
          e.preventDefault()
          axios.put(`http://localhost:8081/updatehjigs/${id}`, values)
      ...
      useEffect(() => {
        axios.get(`http://localhost:8081/getrecordhjigs/${id}`)
            .then((res) => {
                    ...
                    setValues({
                        ...
                        inicioj2: res.data[0].inicioj2,
                        finalj2: res.data[0].finalj2,
                        hrsj2: res.data[0].hrsj2,
                        totalhrsj2: res.data[0].totalhrsj2,
  ...
  return (
    ...
    <h1>Modificar Horometro JIGS</h1>
...
<div className="molino">
  ...
  <select
      ...
      <div className='silos'>
      <div class="mb-2">
          <label form='text' class="form-label"> Inicio J1:</label>
          <input
            type="text"
            class="form-control"
            id='final'
        ...
        <div class="mb-2">
          <label form='text' class="form-label"> Inicio J2:</label>
          <input
            type="text"
            class="form-control"
            id='finalj2'
            ...
            name='icicioj2'
            value={values.inicioj2}
            onChange={(e) => setValues({ ...values, inicioj2: e.target.value })} required/>
        </div>
