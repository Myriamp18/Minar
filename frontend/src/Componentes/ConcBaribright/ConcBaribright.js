...
function ConcBaribright() {
  ...
  const handleDelete = (id) => {
    axios.delete(`http://localhost:8081/deleteconcentradobaribaright/${id}`)
      .then(res => {
  ...
  return (
        ...
        <h1>Concentrado Barbigth:</h1>
    
        <div className="text-center">
          <Link to="/createconcentradobaribaright" className="btn btn-danger btn-lg font-weight-bold   text-lg" >
