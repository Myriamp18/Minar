...
function ModificarDesecho43() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    axios.put(`http://localhost:8081/updatededesecho43/${id}`, values)
...
useEffect(() => {
  axios.get(`http://localhost:8081/getrecorddesecho43/${id}`)
      .then((res) => {
  ...
  return (
    ...
    <h1>Modificar Desecho 4.30:</h1>
    <div className="close-button" onClick={() => navigate('/desecho43')}>
...
export default ModificarDesecho43
