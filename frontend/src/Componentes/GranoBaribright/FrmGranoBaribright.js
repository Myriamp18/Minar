...
function FrmGranoBaribright() {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://localhost:8081/creategranobaribright', { ...values, saldo: nuevoSaldo })
        .then(res => {
            console.log(res);
...
export default FrmGranoBaribright
